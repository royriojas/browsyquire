...
function requireDependencies(src) {
  ...
  return '/* browsyquire injected requires to make browserify include dependencies in the bundle */ /* istanbul ignore next */; (function __makeBrowserifyIncludeModule__() { ' +
    requireDeps(deps) + '});';
}
